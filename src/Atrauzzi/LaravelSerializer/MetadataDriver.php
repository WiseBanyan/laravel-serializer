<?php namespace Atrauzzi\LaravelSerializer {
	...
	class MetadataDriver implements AdvancedDriverInterface {
        ...
        /**
         * Assigns public get and set for a property
         *
         * @param PropertyMetadata $propertyMetadata
         * @param $type
         */
        protected function setAccessTypeMetadata(PropertyMetadata $propertyMetadata, $type)
        {
            $propertyMetadata->setAccessor($type);
        }

        /**
         * Assigns the provided getter and setter for the public property
         *
         * @param PropertyMetadata $propertyMetadata
         * @param array $type
         */
        protected function setAccessorMetadata(PropertyMetadata $propertyMetadata, $type)
        {
            if(!is_array($type))
            {
                throw new NormalException('type must be an array in serializer config');
            }

            $propertyMetadata->setAccessor(null,$type['getter'],$type['setter']);
        }
	}
